...
<div class="menu">
    ...
    <?php
        ...
        echo "<li>" . anchor('jevan/scan/totals', 'View Points by All Participants', 'title="View Scan Totals"'). "</li>";
        echo "<li>" . anchor('jevan/scan/group_totals', 'View Points by Group', 'title="View Group Totals"'). "</li><br/>";

        echo "<li>" . anchor('extra_points', 'Get EXTRA Points!', 'title="Get Extra Points"'). "</li><br/>";

        echo "<li>" . anchor('jevan/delete_cookies', 'Delete Cookies', 'title="Delete Cookie"'). "</li>";
